  ...
  <div class="container-flex">
              <div class="row mb-4 flex-column text-center">
                  <table class="t1" style="height: 150px">
                      <thead>
                          <tr>
                              <th style="text-align: center">{{ $contents[0]['descripcion'] }}</th>
                          ...
                          <tr>
                            ...
                            <td style="width: 50%;text-align: start;margin: 15px;">
                              <div class="border border-success p-2 mb-2">
                                <div class="s4">
                                    <strong>Algodoliva S.C.A</strong>
                                </div>
                                ...
                                <div class="s3">Tlfn; 956137156 E-mail: xxxxx@yyyy.com </div>
                              </div>
                            </td>
                          </tr>
                      </tbody>
                  ...
                  <table class="border border-success p-2 mb-2 t1" >
                    <thead>
                        <tr class="tr1">
                            ...
                            <th class="th2"><strong>Proveedor</strong></th>
                    ...
                    <tbody>
                        <tr class="tr1" style="margin-right: 30px;">
                            <td></td>
                            <td style="margin-right: 30px;">{{ $contents[0]['fechafaccpcb'] }}</td>
                            <td>{{ $contents[0]['cdgfaccpcb'] }}</td>
                            <td>{{ $contents[0]['proveedo'] }}</td>
                        ...
                        <tr>
                          <td></td>
                          <td colspan="4"  class="th2" style="margin-right: 30px;">Dirección Envio: {{ $contents[0]['clidir'] }}</td>
                        </tr>
                    </tbody>
                </table>
                <table class="t1" style="height: 610px; background-image: url(https://algodoliva.es/wp-content/uploads/2019/10/algodologomasclaro.png); background-repeat: no-repeat; background-attachment: fixed; background-size: 50% 20%;background-position: center;opacity:0.1;">
                    ...
                    <tbody class="s3" style="">
                        ...
                        <?php
                        foreach ($contents[0]['albcpcb'] as $albcpcb) {
                            echo " <tr>
                                                  <td></td>
                                                  <td class=\"center s5\"> <strong>Albaran: ";
                            echo print_r($albcpcb['cdgalbcpcb']);
                            echo ' ';
                            echo print_r($albcpcb['fechaalbcpcb']);
                            echo ' ';
                            if (!empty($albcpcb['suref'])) {
                                echo print_r($albcpcb['suref']);
                            }
                            echo "</strong></td>
                                                <tr>
                                              ";
                            foreach ($albcpcb['albcpln'] as $albcpln) {
                                echo "<tr><td class=\"center s5\" style=\"width: 10%;\" > " . $albcpln['articulo'] .
                                    "</td><td class=\"center s5\" style=\"width: 50%;\" > " . $albcpln['detalle1'] . $albcpln['detalle2'] . $albcpln['descripcion'] .
                                    "</td><td class=\"center s7\" style=\"width: 5%;\" > " . $albcpln['cantidad'] .
                                    "</td><td class=\"center s7\" style=\"width: 10%;\" > " . $albcpln['precio'] .
                                    "</td><td class=\"center s7\" style=\"width: 5%;\" > " . $albcpln['dtoalbcpln'] .
                                    "</td><td class=\"center s7\" style=\"width: 5%;text-align: right;margin-right: 20px; \" > " . $albcpln['importe'] .
                                    "</td><tr>";
                            }
                        }
                        ?>
