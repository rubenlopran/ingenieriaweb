...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="container">
                    <form method="POST" action="{{ route('recibida.show') }}"  role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <div style="display: flex;">
                                    <span id="card_title">
                                        <h3><strong>Mis Facturas Recibidas</strong></h3>
                                    </span>
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    <tr style="line-height: 60px;">
                                                        <td style="background-color: rgba(0, 0, 0, 0.03);margin: 10px;text-align: center;">
                                                            <i class="fa-solid fa-calendar-days"></i> <strong style="text-align: center">{{$factura['fechafacvtcb']}}</strong>
                                                        </td>
                                                        <td style="background-color: rgba(0, 0, 0, 0.03);margin: 10px;text-align: center;">
                                                            <i class="fa-solid fa-file-invoice"></i> <strong style="text-align: end"><?php echo (($factura['cdgfacvtcb']));?></strong>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div class="nav-item">
                                                                <form method="POST" action="{{ route('recibida.showFactura') }}"  role="form" enctype="multipart/form-data" id="showFactura">
                                                                    @csrf
                                                                    <a class="nav-link active" style="margin-bottom: 10px;background-color: rgb(94, 168, 94);border-radius: 30px;">
                                                                        <button id="codigo" name="codigo"  form="showFactura" class="btn btn-sm" style="background-color:  rgb(94, 168, 94);" value="{{$factura['cdgfacvtcb']}}">
